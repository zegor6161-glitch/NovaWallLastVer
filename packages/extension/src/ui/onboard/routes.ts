...
if (__IS_FIREFOX__) {
  routes.unshift({ path: '/new-wallet', component: NewWallet, name: 'new-wallet' });
  routes.unshift({ path: '/', component: UserAnalytics, name: 'user-analytics' });
  routes.unshift({ path: '/user-privacy', component: UserAnalytics, name: 'user-privacy' });
} else {
