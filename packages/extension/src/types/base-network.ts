...
export interface BaseNetworkOptions {
  ...
  api: () => Promise<EvmAPI> | Promise<BitcoinAPI>;
  customTokens?: boolean;
}

/** Shared representation for Ethereum/L2 and Bitcoin networks in the CWS release. */
export abstract class BaseNetwork {
  ...
  public api: () => Promise<EvmAPI> | Promise<BitcoinAPI>;
