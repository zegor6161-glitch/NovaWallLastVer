    ...
    alias: [
      ...(IS_CWS_BUILD
        ? [
            ...
            { find: '@enkryptcom/signer-polkadot', replacement: local('./src/config/cws-disabled-signer-stub.ts') },
            { find: '@enkryptcom/signer-kadena', replacement: local('./src/config/cws-disabled-signer-stub.ts') },
            { find: '@enkryptcom/signer-massa', replacement: local('./src/config/cws-disabled-signer-stub.ts') },
