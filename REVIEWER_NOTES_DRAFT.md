...
- Promo/reward/survey surfaces are disabled to keep UX wallet-focused; `VITE_CWS_REVIEW_BUILD=true` additionally disables telemetry and remote backup behavior for review-focused builds.
