...
- **Privacy contact email:** `privacy@nova-wallet.example` (replace with production contact)
- **Support URL:** `https://example.com/support` (replace with production support page)
